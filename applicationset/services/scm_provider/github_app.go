...
func NewGithubAppProviderFor(ctx context.Context, g github_app_auth.Authentication, organization string, url string, allBranches bool, enableTokenCache bool, optionalHTTPClient ...*http.Client) (*GithubProvider, error) {
